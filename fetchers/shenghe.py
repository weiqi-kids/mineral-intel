...
class ShengheFetcher(CompanyFetcher):
    """Shenghe Resources 爬蟲"""

    company_id = "shenghe"
    company_name = "Shenghe Resources"
    news_url = "https://www.shengheresources.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.shengheresources.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Shenghe Resources")
        return documents
