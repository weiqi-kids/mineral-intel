"""
China Rare Earth Holdings 官網爬蟲
"""
...
class ChinaRareEarthFetcher(CompanyFetcher):
    """China Rare Earth Holdings 爬蟲"""

    company_id = "china_rare_earth"
    company_name = "China Rare Earth Holdings"
    news_url = "https://www.chinarareearthholdings.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.chinarareearthholdings.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from China Rare Earth Holdings")
        return documents
