...
class RainbowFetcher(CompanyFetcher):
    """Rainbow Rare Earths 爬蟲"""

    company_id = "rainbow"
    company_name = "Rainbow Rare Earths"
    news_url = "https://www.rainbowrareearths.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.rainbowrareearths.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Rainbow Rare Earths")
        return documents
