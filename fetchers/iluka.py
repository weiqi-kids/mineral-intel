...
class IlukaFetcher(CompanyFetcher):
    """Iluka Resources 爬蟲"""

    company_id = "iluka"
    company_name = "Iluka Resources"
    news_url = "https://www.ilukaresources.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.ilukaresources.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Iluka Resources")
        return documents
