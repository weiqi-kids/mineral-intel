...
class ArafuraFetcher(CompanyFetcher):
    """Arafura Rare Earths 爬蟲"""

    company_id = "arafura"
    company_name = "Arafura Rare Earths"
    news_url = "https://www.arafurarareearths.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.arafurarareearths.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Arafura Rare Earths")
        return documents
