"""
Hastings Technology Metals 官網爬蟲
"""
...
class HastingsFetcher(CompanyFetcher):
    """Hastings Technology Metals 爬蟲"""

    company_id = "hastings"
    company_name = "Hastings Technology Metals"
    news_url = "https://www.hastingstechnologymetals.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.hastingstechnologymetals.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Hastings Technology Metals")
        return documents
