"""
Neo Performance Materials 官網爬蟲
"""
...
class NeoFetcher(CompanyFetcher):
    """Neo Performance Materials 爬蟲"""

    company_id = "neo"
    company_name = "Neo Performance Materials"
    news_url = "https://www.neoperformancematerials.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.neoperformancematerials.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Neo Performance Materials")
        return documents
