...
class UcoreFetcher(CompanyFetcher):
    """Ucore Rare Metals 爬蟲"""

    company_id = "ucore"
    company_name = "Ucore Rare Metals"
    news_url = "https://www.ucoreraremetals.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.ucoreraremetals.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ucore Rare Metals")
        return documents
