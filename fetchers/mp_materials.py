...
class MpMaterialsFetcher(CompanyFetcher):
    """MP Materials 爬蟲"""

    company_id = "mp_materials"
    company_name = "MP Materials"
    news_url = "https://www.mpmaterials.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.mpmaterials.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from MP Materials")
        return documents
