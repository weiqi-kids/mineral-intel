...
class EnergyFuelsFetcher(CompanyFetcher):
    """Energy Fuels 爬蟲"""

    company_id = "energy_fuels"
    company_name = "Energy Fuels"
    news_url = "https://www.energyfuels.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.energyfuels.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Energy Fuels")
        return documents
