...
class PensanaFetcher(CompanyFetcher):
    """Pensana 爬蟲"""

    company_id = "pensana"
    company_name = "Pensana"
    news_url = "https://www.pensana.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Pensana")
        return documents
