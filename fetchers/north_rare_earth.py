"""
China Northern Rare Earth 官網爬蟲
"""
...
class NorthRareEarthFetcher(CompanyFetcher):
    """China Northern Rare Earth 爬蟲"""

    company_id = "north_rare_earth"
    company_name = "China Northern Rare Earth"
    news_url = "https://www.chinanorthernrareearth.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.chinanorthernrareearth.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from China Northern Rare Earth")
        return documents
