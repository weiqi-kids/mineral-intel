"""
Australian Strategic Materials 官網爬蟲
"""
...
class AsmFetcher(CompanyFetcher):
    """Australian Strategic Materials 爬蟲"""

    company_id = "asm"
    company_name = "Australian Strategic Materials"
    news_url = "https://www.australianstrategicmaterials.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.australianstrategicmaterials.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Australian Strategic Materials")
        return documents
