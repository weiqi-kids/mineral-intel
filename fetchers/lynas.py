...
class LynasFetcher(CompanyFetcher):
    """Lynas Rare Earths 爬蟲"""

    company_id = "lynas"
    company_name = "Lynas Rare Earths"
    news_url = "https://www.lynasrareearths.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lynasrareearths.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Lynas Rare Earths")
        return documents
