...
class VitalFetcher(CompanyFetcher):
    """Vital Metals 爬蟲"""

    company_id = "vital"
    company_name = "Vital Metals"
    news_url = "https://www.vitalmetals.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.vitalmetals.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Vital Metals")
        return documents
